...
- Is stored securely in our Firebase database
- Is not shared with third parties
- Is automatically deleted when the demo period expires or when you
  uninstall the app

This data is collected solely to enforce the demo time limit.
